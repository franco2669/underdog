export const site = {
  url: "https://www.underdogheroes.org",
  name: "Underdog Heroes"
};

export const contact = {
  adoptEmail: "Adopt@underdogheroes.org",
...
export const nav = [
  ...
  { id: "happy", label: "Happy Endings", href: "/happy-endings/" },
  { id: "dogs", label: "Dogs", href: "/dogs/" },
...
export const stories = [
  {
    ...
    chapters: [
      ...
      {
        kicker: "Rehab",
        title: "Trust had to be rebuilt slowly.",
        posterTitle: "Pulse",
        poster: "pulse",
        image: "foster-room",
        copy: [
      ...
      {
        kicker: "Home",
        title: "She became somebody's dog.",
        posterTitle: "Home",
        poster: "doorway",
        image: "home-safe",
        copy: [
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        kicker: "Patience",
        title: "The right partner understood the climb.",
        posterTitle: "Work",
        poster: "list",
      ...
      {
        kicker: "Placed",
        title: "Counted out did not mean finished.",
        posterTitle: "Placed",
        poster: "doorway",
        image: "home-safe",
        copy: [
...
export const faqs = [
  ...
  },
  {
    ...
    a: "Fostering is free. The rescue provides supplies and financial support until the foster dog is adopted."
  },
  {
